...
export default function Login({ navigation }) {
    ...
    return (
        // KeyboardAvoidingView normal mente so é necessario no IOS, mas no meu aparelho foi necessario.
        <KeyboardAvoidingView behavior="padding" style={styles.conteiner}> 
            <Image source={logo} />

            <View style={styles.form}>

                <Text style={styles.lable}>SEU E-MAIL *</Text>
                <TextInput 
                    style={styles.input}
                ...
                <Text style={styles.lable}>TECNOLOGIAS *</Text>
                <TextInput 
                    style={styles.input}
